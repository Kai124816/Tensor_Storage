...
void MTTKRP_BLCO_3D(int mode, Blco_Tensor<T,S>& sparse_tensor, std::vector<float>& times, int iter = 1)
{
...
//======================================================================
template<typename T, typename S>
void MTTKRP_BLCO_4D(int mode, Blco_Tensor<T,S>& sparse_tensor, std::vector<float>& times, int iter = 1)
{
...
//======================================================================
template<typename T, typename S>
void MTTKRP_BLCO_CSR_4D(int mode, Blco_Tensor<T,S>& sparse_tensor, std::vector<float>& times, int iter = 1)
{
    const std::vector<BLCO_BLOCK_CPU<T>> blco_cpu = sparse_tensor.get_blco();
    const std::vector<int> dims = sparse_tensor.get_dims();
    const int rank = sparse_tensor.get_factor_rank();
...
//======================================================================
template<typename T, typename S>
void MTTKRP_BLCO_5D(int mode, Blco_Tensor<T,S>& sparse_tensor, std::vector<float>& times, int iter = 1)
{
    const std::vector<int> dims = sparse_tensor.get_dims();
    const int rank = sparse_tensor.get_factor_rank();
    uint64_t nnz = sparse_tensor.get_nnz();
...
{
    int dimension = sparse_tensor.get_dims().size();
    if(dimension == 3){
        MTTKRP_BLCO_3D(mode, sparse_tensor, times, iter);
    }
    else if(dimension == 4){
        if(sparse_tensor.get_total_bits_needed() > 74){
            MTTKRP_BLCO_CSR_4D(mode, sparse_tensor, times, iter);
        }
        else{
            MTTKRP_BLCO_4D(mode, sparse_tensor, times, iter);
        }
    }
    else if(dimension == 5){
        MTTKRP_BLCO_5D(mode, sparse_tensor, times, iter);
    }
    else{
        return;
    }
...
//======================================================================
template void Initialize_MTTKRP<int, uint64_t>(int, Blco_Tensor<int, uint64_t>&, std::vector<float>&, int);
template void Initialize_MTTKRP<float, uint64_t>(int, Blco_Tensor<float, uint64_t>&, std::vector<float>&, int);
template void Initialize_MTTKRP<unsigned long long, uint64_t>(int, Blco_Tensor<unsigned long long, uint64_t>&, std::vector<float>&, int);
template void Initialize_MTTKRP<double, uint64_t>(int, Blco_Tensor<double, uint64_t>&, std::vector<float>&, int);
template void Initialize_MTTKRP<int, __uint128_t>(int, Blco_Tensor<int, __uint128_t>&, std::vector<float>&, int);
template void Initialize_MTTKRP<float, __uint128_t>(int, Blco_Tensor<float, __uint128_t>&, std::vector<float>&, int);
template void Initialize_MTTKRP<unsigned long long, __uint128_t>(int, Blco_Tensor<unsigned long long, __uint128_t>&, std::vector<float>&, int);
template void Initialize_MTTKRP<double, __uint128_t>(int, Blco_Tensor<double, __uint128_t>&, std::vector<float>&, int);
