...
//======================================================================
template void MTTKRP_BLCO_VEC<int, uint64_t>(int, Blco_Tensor<int, uint64_t>&, std::vector<float>&, int);
template void MTTKRP_BLCO_VEC<float, uint64_t>(int, Blco_Tensor<float, uint64_t>&, std::vector<float>&, int);
template void MTTKRP_BLCO_VEC<unsigned long long, uint64_t>(int, Blco_Tensor<unsigned long long, uint64_t>&, std::vector<float>&, int);
template void MTTKRP_BLCO_VEC<double, uint64_t>(int, Blco_Tensor<double, uint64_t>&, std::vector<float>&, int);
template void MTTKRP_BLCO_VEC<int, __uint128_t>(int, Blco_Tensor<int, __uint128_t>&, std::vector<float>&, int);
template void MTTKRP_BLCO_VEC<float, __uint128_t>(int, Blco_Tensor<float, __uint128_t>&, std::vector<float>&, int);
template void MTTKRP_BLCO_VEC<unsigned long long, __uint128_t>(int, Blco_Tensor<unsigned long long, __uint128_t>&, std::vector<float>&, int);
template void MTTKRP_BLCO_VEC<double, __uint128_t>(int, Blco_Tensor<double, __uint128_t>&, std::vector<float>&, int);
